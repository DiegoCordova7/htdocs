...
try {
  ...
  // Reemplazar las x por el id del autor
  $consultaSQL .= "WHERE A.id=X";
...
<div class="row">
  <div class="col-md-12">
    ...
    ?>
        <h2 class="mt-3">NOMBRE DEL AUTOR AQUI</h2><br>
        <h3 class="mt-3">Obras: </h3>
        <ul>
          <li>
            <b>
              <a href="http://localhost/Mangas_2.0/<?php echo escapar($fila["direccion"]); ?>" target="_parent">
