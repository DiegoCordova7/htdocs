...
try {
  ...
  // Reemplazar las x por el id del manga
  $consultaSQL .= "WHERE M.id=xx";
...
<div class="row">
  <div class="col-md-12">
    ...
    ?>
        ...
        <p><b>Autor: </b><a href="<?php echo escapar($fila["enlace"]); ?>" target="_parent"><?php echo escapar($fila["autor_nombre"]); ?></a></p>
        <p><b>Estado: </b><?php echo escapar($fila["estado_act"]); ?></p>
        <p><b>Número De Capitulos: </b><?php echo escapar($fila["num_capitulos"]); ?></p>
        <p><b>Número De Volúmenes: </b><?php echo escapar($fila["num_volumenes"]); ?></p>
        <p><b>Año De Estreno: </b><?php echo escapar($fila["fecha_creacion"]); ?></p>
        <p><a href="<?php echo escapar($fila["descarga"]); ?>" target="_black"><img src="img\descargamanga.png" width="350" height="100" alt="link de descarga"></a></p>
    <?php
      }
    }
    ?>
