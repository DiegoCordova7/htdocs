<div class="container is-fluid mb-1">
    <h1 class="title">Regla de 3 Inversa</h1>
            ...
            <tr style="border: hidden">
                ...
                <td style="border: hidden">
                    ...
                    if ($_SERVER["REQUEST_METHOD"] == "POST") {
                        $valorConocido1 = $_POST['a'];
                        $valorConocido2 = $_POST['b'];
                        $valorDeseado1 = $_POST['c'];
                    }
                    if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    ...
                    if ($_SERVER["REQUEST_METHOD"] == "POST") {
                        if (is_numeric($resultado)) {
                            echo "x=(" . $valorConocido1 . "x" . $valorConocido2 . ")/" . $valorDeseado1 . "<br>
                                        x=(" . $valorConocido1 * $valorConocido2 . ")/" . $valorDeseado1 . "<br>
                                        x=" . $resultado . "<br>
