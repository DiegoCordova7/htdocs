        ...
        if ($y1 == 0) {
            ...
            if (!((($m2_1 * $x1) - ($y1 * $m2_2)) > 0)) {
                echo '
                    ...
                    y2=-' . $m2_1 . '/' . ($m2_2 * -1) . 'x-' . $m2_1 * -1 * $x1 . '/' . ($m2_2 * -1) . '+' . $y1 . '<br>
                    y2=-' . $m2_1 . '/' . ($m2_2 * -1) . 'x-' . $m2_1 * -1 * $x1 . '/' . ($m2_2 * -1) . '+' . $y1 * ($m2_2 * -1) . '/' . ($m2_2 * -1) . '<br>
                    y2=-' . $m2_1 . '/' . ($m2_2 * -1) . 'x-' . ($m2_1 * -1 * $x1) - (-1 * $y1 * $m2_2) . '/' . ($m2_2 * -1) . '<br>';
            } elseif ($m2_1 * $x1 == 0) {
                echo '
                    y2=(' . $m2_1 . 'x-' . $m2_1 * $x1 . ')/' . $m2_2 . ')' . $y1 . '<br>
                    y2=' . $m2_1 . '/' . $m2_2 . 'x-' . $m2_1 * $x1 . '/' . $m2_2 . $y1 . '<br>
                ...
                if ($y1 > 0) {
                    ...
                    y2=' . $m2_1 . '/' . $m2_2 . 'x-' . $x1 * $m2_1 * -1 . '/' . -1 * $m2_2 . $y1 * $m2_2 . '/' . -1 * $m2_2 . '<br>
                    y2=' . $m2_1 . '/' . $m2_2 . 'x' . ($x1 * $m2_1 * -1) + ($y1 * $m2_2) . '/' . -1 * $m2_2;
                } elseif ($y1 < 0)
                    echo '
                    y2=(' . $m2_1 . '*(x+' . -1 * $x1 . '))/' . $m2_2 . ')' . $y1 . '<br>
                    y2=(' . $m2_1 . 'x+' . -1 * $x1 * $m2_1 . ')/' . $m2_2 . ')' . $y1 . '<br>
